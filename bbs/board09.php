...
<!--모바일인경우--> <div class="login login_mobile"><a href="">로그인</a></div>
<!-- popup -->
<div class="black_bg">
<section class="popup" id="pop01">
    ...
    <form name="foutlogin" action="" onsubmit="return fhead_submit(this);" method="post" autocomplete="off">
    	<input type="hidden" name="url" value="%2Fbbs%2Fboard.php%3Fbo_table%3Dgallery%26wr_id%3D11">
        <div class="pop_cont" style="max-height: 798px;">
        	<div class="pop_in">
                ...
                <div class="auto">
                	<label> <input type="checkbox" name="auto_login" value="1" id="auto_login">자동로그인</label><a href="" id="">아이디 비밀번호 찾기</a>
                </div>
          ...
          <img src="../img/main/login_site02.png" alt="페이스북">
           ...
           <img src="../bbs/sub08.html/img/main/login_site05.png" alt="트위터">
        </a>
            ...
            <div class="last_login">
            	<dl>
                	<dd>회원이 아니십니까?</dd>
                    <dt><a href="" class="last_btn">회원가입</a></dt>
                </dl>
            </div>
        </div>
        </form></div>
...
<!-- //header -->
		...
		<section id="sub_content">
				 <article class="sub_visual sub_visual02">
      <p><span>사랑스런 아기와 교감하는</span><br>
 <em>소중한 시간이 되시길 바랍니다.</em>
</p>
  </article><!--//sub_visual-->
...
<div class="text_area">
 ...
 <div class="notice_view">
            	<dl>
                	<dt>일반실</dt>
                    <dd><span><img src="../img/sub/ico_time.png" alt="작성시각">18.03.20 </span><em><img src="../img/sub/ico_view.png" alt="보기">22</em></dd>
                </dl>
...
<ul id="bo_v_sns">
    <li><a href="http://sample01.openfield.co.kr/bbs/sns_send.php?longurl=http%3A%2F%2Fsample01.openfield.co.kr%2Fbbs%2Fboard.php%3Fbo_table%3Dgallery%26wr_id%3D11&amp;title=%EC%99%B8%EA%B4%80&amp;sns=twitter" target="_blank" class="sns_t"><img src="http://sample01.openfield.co.kr/plugin/sns/icon/twitter.png" alt="트위터로 보내기" width="20"></a></li>
    <li><a href="http://sample01.openfield.co.kr/bbs/sns_send.php?longurl=http%3A%2F%2Fsample01.openfield.co.kr%2Fbbs%2Fboard.php%3Fbo_table%3Dgallery%26wr_id%3D11&amp;title=%EC%99%B8%EA%B4%80&amp;sns=facebook" target="_blank" class="sns_f"><img src="http://sample01.openfield.co.kr/plugin/sns/icon/facebook.png" alt="페이스북으로 보내기" width="20"></a></li>
    <li><a href="http://sample01.openfield.co.kr/bbs/sns_send.php?longurl=http%3A%2F%2Fsample01.openfield.co.kr%2Fbbs%2Fboard.php%3Fbo_table%3Dgallery%26wr_id%3D11&amp;title=%EC%99%B8%EA%B4%80&amp;sns=gplus" target="_blank" class="sns_g"><img src="http://sample01.openfield.co.kr/plugin/sns/icon/gplus.png" alt="구글플러스로 보내기" width="20"></a></li>
    </ul>
</div> -->
                ...
                <div class="view_text">
									<div id="bo_v_img">
<a href="../data/file/gallery/thumb-1893611149_YD6Zipvy_dc96d34102c984c9f061b7f73ee01f1c880285a8_1380x550.jpg" target="_blank" width="1380" height="550"><img src="../data/file/gallery/thumb-1893611149_YD6Zipvy_dc96d34102c984c9f061b7f73ee01f1c880285a8_1380x550.jpg"></a></div>

        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con"><p>가족이 같이 지낼 수 있는 일반실입니다.<br></p></div>
                <!-- } 본문 내용 끝 -->
               ...
               <div class="btn_confirm center">
                      ...
                      <em class="not"><a href="../bbs/sub04.html" class="btnType02">목록</a></em>
             </div>
...
<div id="cmTopScroll" class="TopScroll"> <a href="#header" class="top">TOP</a> </div>
  ...
  <footer>
	<p><span>CARE 산후조리원</span>  <em>|</em>  주소 : 경기도 김포시 고촌읍 신곡리 1068-1 엔타운 <em>|</em> <span>사업자등록번호 : 000-00-00000</span> <br>
